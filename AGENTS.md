...
- semantic-commit-ja: Create, review, amend, or validate Japanese Conventional Commit messages from the actual Git changes. Use by default for commit-related tasks unless the user explicitly requests another language or convention. (file: skills/semantic-commit-ja/SKILL.md)
