...
- bind attestation to a start-of-review Git and worktree fingerprint, including branch-mode dirty bytes, force Git to reveal ignored submodule state, and reject dirty submodules whose inner bytes are not pinned by the superproject;
