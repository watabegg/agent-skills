...
- Start a Codex agent configured for model `gpt-6-luna` and reasoning effort `max`; verify the actual launch configuration or agent metadata before reporting that GPT-6 Luna/max was used.
